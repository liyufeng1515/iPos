angular.module("iPosApp.services",[])
    ...
    .service('CustomerService',function($http,$q,ConfigService){
      return {
        findCustomerList:function(data){
          var deferred = $q.defer();
          $http({
            method:'POST',
    ...
    .service('OrderService',function($http,$q,ConfigService){
      return {
        findOrderList:function(data){
          var deffered = $q.defer();
          $http({
            method:'POST',
            url:ConfigService.getHostURL()+"findOrderWebPos",
            data:data
          }).success(function(data,status,header,config){
